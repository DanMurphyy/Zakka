...
import com.hfad.zakovatuz.databinding.FragmentBadResult3Binding
import java.io.File
import java.io.FileOutputStream

class BadResult3Fragment : Fragment() {
    private var _binding: FragmentBadResult3Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBadResult3Binding.inflate(inflater, container, false)

        val view = binding.root
        var numQuestions = BadResult3FragmentArgs.fromBundle(requireArguments()).numQuestions
        var incorrectGuesses = BadResult3FragmentArgs.fromBundle(requireArguments()).incorrectGuesses
        var inCorrectJavoblar = BadResult3FragmentArgs.fromBundle(requireArguments()).inCorrectJavoblar
        var correctJavoblar = BadResult3FragmentArgs.fromBundle(requireArguments()).correctJavoblar
    ...
    private fun generateLayoutPhoto(): Bitmap {
        ...
        val viewToShare = binding.umimiyNatija3
